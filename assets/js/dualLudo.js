...
const holdingsbtnludo2 = document.querySelector(".holdingsbtnludo2");
const pointexchcontainerludo2 = document.querySelector(".pointexchcontainerludo2");
const holdingsludo2 = document.querySelector(".holdingsludo2");
const holdingclosepointludo2 = document.querySelector(".holdingclosepointludo2");
const infoCancel1211ludo2 = document.querySelector(".infoCancel1211ludo2");
const closePointHoldingsludo2 = document.querySelector(".closePointHoldingsludo2");
...
pointexchcontainerludo2.style.display = "none";
pointbtn.addEventListener("click", function () {
  if (pointexchcontainerludo2.style.display == "none") {
    pointexchcontainerludo2.style.display = "block";
    sliderBackDrop.style.display = "none";
    sliderMenu.classList.remove("sliderMenuActive");
  } else {
    sliderMenu1.style.display = "block";
...
holdingsludo2.style.display = "none";
holdingsbtnludo2.addEventListener("click", function () {
  if (holdingsludo2.style.display == "none") {
    holdingsludo2.style.display = "flex";
    exchangeBody.style.display = "none";
    sliderBackDrop.style.display = "none";
    sliderMenu.classList.remove("sliderMenuActive");
  } else {
...
infoCancel1211ludo2.addEventListener("click", function () {
    pointexchcontainerludo2.style.display = "none";
  });
closePointHoldings.addEventListener("click", function () {
  holdings.style.display = "none";
});
closePointHoldingsludo2.addEventListener("click", function () {
    holdingsludo2.style.display = "none";
  });
...
function generateHistoryTable222(number) {
  ...
  newHistory.innerHTML = `
    <div class="historyCol1">${totalHistory2}</div>
        ...
        <i class="bi bi-caret-${number < 4 ? "down" : "up"}-fill ${
    number < 4 ? "Under" : "Over"
  }"></i>
        
         </div>
        <div class="historyCol1 ${number % 2 == 0 ? "Even" : "Odd"}">${
    number % 2 == 0 ? "E" : "O"
  }</div>
        <div class="historyCol1">
