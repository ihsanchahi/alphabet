...
const ouOdds = document.querySelector(".ouOdds");
...
const ExchangeApplication = document.querySelector(
  ".my-backdropExchangeApplication"
);
...
const OpenSelectLeaguePopup = document.querySelector(
  ".my-backdropSelectLeague"
);
    ...
    <div class="extraOddsContainer${indx}${key}">
      ...
      for (i = 0; i < reps; i++) {
        ...
        allBetsDiv.innerHTML = `
                    ...
                    `;
        const extraOddsContainer = document.querySelector(
          `.extraOddsContainer${indx}${key}`
        );
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  pointExchangeToggleBtn.addEventListener("click", () => {
    ...
    let ExhangeApplicationBtn = document.querySelector(
      ".ExchangeApplicationBtn"
    );
